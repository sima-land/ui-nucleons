...
test('Button should be on page', async ({ page }) => {
  await page.goto('/iframe.html?args=&id=common-button--primary&viewMode=story');
...
test('Buttons with different colors should be on page', async ({ page }) => {
  await page.goto('/iframe.html?args=&id=common-button--different-colors&viewMode=story');
...
test('Buttons with different sizes should be on page', async ({ page }) => {
  await page.goto('/iframe.html?args=&id=common-button--different-sizes&viewMode=story');
...
test('Buttons with only icon should be on page', async ({ page }) => {
  await page.goto('/iframe.html?args=&id=common-button--only-icon&viewMode=story');
...
test('Buttons with start icon should be on page', async ({ page }) => {
  await page.goto('/iframe.html?args=&id=common-button--icon-start&viewMode=story');
...
test('Buttons with end icon should be on page', async ({ page }) => {
  await page.goto('/iframe.html?args=&id=common-button--icon-end&viewMode=story');
